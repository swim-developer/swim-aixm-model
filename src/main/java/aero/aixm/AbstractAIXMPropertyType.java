...
import aero.aixm.event.AISProductPropertyType;
import aero.aixm.event.ASHTAMPropertyType;
import aero.aixm.event.NOTAMPropertyType;
import aero.aixm.event.RunwayAssessmentPropertyType;
import aero.aixm.event.SNOWTAMPropertyType;
...
@XmlSeeAlso({
    ...
    AISMessagePropertyType.class,
    AISProductPropertyType.class,
    ASHTAMPropertyType.class,
    NOTAMPropertyType.class,
    RunwayAssessmentPropertyType.class,
    SNOWTAMPropertyType.class
})
